<template>
    <div>
        <!--<mt-header title="门店编码查询" style="position: fixed;">
            <router-link to="/history" slot="right">
                <mt-button>历史订单</mt-button>
            </router-link>
        </mt-header>-->
        ...
        <div v-if="ind == 1">
            <!-- 第几公司 -->
            <!--<mt-field v-model="store_name" label="隶属公司" placeholder="请输入隶属公司"></mt-field>-->
            <mt-cell title="隶属公司" style="position:relative;">
                <el-select v-model="company" placeholder="请选择" style="width:70%;position:absolute;right:0;top:.4rem;">
            ...
            <p class="tip">点击 <router-link to="/history">历史订单</router-link> ， 进入出货系统历史查询</p>
        </div>
...
<style>
.checked_tab { position: fixed; left: 0; top: 0; width: 100%; height: 45px; border-bottom: 1px solid #eee; box-sizing: border-box; z-index: 99;}
.checked_tab span { float: left; width: 50%; height: 44px; text-align: center; line-height: 44px; box-sizing: border-box; background: #fff;}
.checked_tab span.curr { background: #ef4f4f; color: #fff;}
