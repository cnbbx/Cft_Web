<template>
  <div class="page-navbar">
    ...
    <mt-cell title="隶属公司">
      <el-select v-model="inputval.company" placeholder="请选择">
    ...
    <mt-tab-container v-model="inputval.few">
      <mt-tab-container-item id="1">
        <mt-cell :label="item.boutique_name" v-for="item in inputval.first">
          <el-input-number size="small" v-model="item.num" @change="handleChange" :min="0" :max="500"></el-input-number>&nbsp;<span>{{item.unit}}</span></mt-cell>
    ...
    <mt-field v-model="inputval.remark" label="备注" placeholder="请输入备注" type="textarea" rows="4"></mt-field>
